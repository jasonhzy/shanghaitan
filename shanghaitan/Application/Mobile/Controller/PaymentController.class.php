...
class PaymentController extends MobileBaseController {
    ...
    public function returnUrl(){
        ...
        if(stripos($result['order_sn'],'recharge') !== false)
        {
            ...
            if($result['status'] == 1)
                echo "<script>window.location='/index.php?m=Mobile&c=User&a=vipPay'</script>";
            else
                echo "<script>window.location='/index.php?m=Mobile&c=User&a=vipPay'</script>";
            exit();
        }
        ...
        $this->assign('order', $order);
        if($result['status'] == 1)
            echo "<script>window.location='/index.php?m=Mobile&c=User&a=order_detail&id='+$id</script>";
        else
            echo "<script>window.location='/index.php?m=Mobile&c=User&a=order_detail&id='+$id</script>";
    }
}
