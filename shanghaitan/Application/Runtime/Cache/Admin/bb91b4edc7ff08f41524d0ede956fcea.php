              ...
              <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="key_word" value="" placeholder="公司名称或者所属城市" id="input-order-id" class="form-control">
                  </div>
                </div>                  
                <!--排序规则-->
                ...
                <button type="button" onclick="location.href='<?php echo U('Admin/Goods/addEditGoods');?>'" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加新商户</button>
              </form>
          </div>
