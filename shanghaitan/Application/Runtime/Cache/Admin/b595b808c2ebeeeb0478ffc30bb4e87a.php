...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index.php/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="<?php echo ($tpshop_config['shop_info_store_logo']); ?>" width="100" height="40"></span>
      </a>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   ...
	   <strong>Copyright &copy; 2016 <a href="#">上海滩</a>.</strong>保留所有权利。
	</footer>
...
<!--<div id="ordfoo" class="orderfoods" style="">-->
    ...
    <!--<div class="dor_foot">-->
       <!--<p class="te-in">您有<span id="orderAmount"><?php echo ($order_amount); ?></span>个订单待处理</p>-->
        <!--&lt;!&ndash;<p class="te-al-ce"><a href="<?php echo U('Order/Index');?>"><span>点击查看</span></a></p>&ndash;&gt;-->
    <!--</div>-->
<!--</div>-->
<script type="text/javascript">
	function closes(){
