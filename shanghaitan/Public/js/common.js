...
function get_category(id,next,select_id){
    ...
    $.ajax({
        ...
        success: function(v) {
			v = "<option value='0'>请选择服务分类</option>" + v;
            $('#'+next).empty().html(v);
 ...
 * 获取多级联动的服务分类
 */
function get_lifeCategory(id,next,select_id){
    var url = '/index.php?m=Home&c=api&a=get_lifeCategory&parent_id='+ id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
 ...
 * 获取多级联动旅游分类
 */
function get_travelCategory(id,next,select_id){
    var url = '/index.php?m=Home&c=api&a=get_travelCategory&parent_id='+ id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
